...
public class MyBaseExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public void setData( List<Map<String, Object>> parentMapList, List<List<Map<String, Object>>> childMapList_list){
    ...
    public View getChildView(final int groupPosition, final int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        childViewHolder.id_cb_select_child.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                onAllCheckedBoxNeedChangeListener.onCheckedBoxNeedChange(dealAllParentIsChecked());
                dealPrice();
                iBay.boy(groupPosition,childPosition);
            }
        });
        ...
        childViewHolder.id_tv_goods_delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                iDelate.delete(groupPosition, childPosition);
    ...
    //删除接口
    private IDelate iDelate;
    public interface IDelate{
        void delete(int groupPosition, int childPosition);
    }

    public void setiDelate(IDelate iDelate) {
        this.iDelate = iDelate;
    }
    private IBay iBay;
    public interface IBay{
        void boy(int groundPosintion,int childPosition);
    }

    public void setiBay(IBay iBay) {
        this.iBay = iBay;
    }
}
