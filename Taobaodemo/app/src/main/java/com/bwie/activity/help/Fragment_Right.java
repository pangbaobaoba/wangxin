...
public class Fragment_Right extends Fragment {
    ...
    private void getClassify_2_data() {
        String url= "http://169.254.229.178/mobile/index.php?act=goods_class"+"&gc_id="+gc_id;
    ...
    private void getClassify_3_data()
    {
        ...
        timer.schedule(new TimerTask() {
            ...
            public void run() {
                //开始请求
                String third_url="http://169.254.229.178/mobile/index.php?act=goods_class"+"&gc_id="+strings.get(start);
                OkHttp3Utils.doGet(third_url, new Callback() {
                    @Override
                    public void onFailure(Call call, IOException e) {
                    }
                    @Override
